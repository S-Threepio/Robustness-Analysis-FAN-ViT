...
def testBIM(model, trad_model, device, test_loader, epsilon, ip_steps):
    ...
    print(
        ...
        ip_steps,
        "\n"
        "\n\n transferability for BIM attack = adversarial examples working on FAN vits/adversarial examples working on traditional vits = {}/{} = {}".format(
